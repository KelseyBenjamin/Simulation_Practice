...
int LanderSimObject::call_function ( Trick::JobData * curr_job ) {
...
double LanderSimObject::call_function_double ( Trick::JobData * curr_job ) {
...
SimEnvironment::SimEnvironment() {
    ...
    local_env["TRICK_EXEC_LINK_LIBS"] = " -L/usr/lib64 -lpython2.7 -lpthread -ldl  -lutil -lm -ludunits2 -lrt -lm -ldl -lhdf5_hl -lhdf5 -lgsl -lgslcblas";
    ...
    local_env["TRICK_HOME"] = "/users/trick/trick17";
    ...
    local_env["TRICK_PATH"] = "/users/trick/trick17/libexec/bin";
    ...
    local_env["TRICK_SYSTEM_CFLAGS"] = "-I/users/trick/trick17/trick_source -I/users/trick/trick17/include -I/users/trick/trick17/include/trick/compat -DTRICK_VER=17 -DTRICK_MINOR=5 -fpic -I/usr/include/udunits2 -DUSE_ER7_UTILS_INTEGRATORS -D_HAVE_GSL -fexceptions ";
    setenv("TRICK_SYSTEM_CFLAGS", local_env["TRICK_SYSTEM_CFLAGS"].c_str(), 0);
    local_env["TRICK_SYSTEM_CXXFLAGS"] = "-I/users/trick/trick17/trick_source -I/users/trick/trick17/include -I/users/trick/trick17/include/trick/compat -DTRICK_VER=17 -DTRICK_MINOR=5 -fpic -I/usr/include/udunits2 -DUSE_ER7_UTILS_INTEGRATORS -D_HAVE_GSL ";
    ...
    local_env["XML_CATALOG_FILES"] = "/users/trick/trick17/libexec/trick_source/data_products/DPX/XML/catalog.xml";
...
void memory_init( void ) {
    ...
    TMM_declare_ext_var(&dyn, TRICK_STRUCTURED,"LanderSimObject", 0, "dyn", 0, NULL) ;
